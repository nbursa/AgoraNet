    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-6 w-full max-w-3xl mx-auto">
      ...
      <div className="mt-6 w-full border border-gray-500 p-4 mb-4 rounded-lg shadow-md flex flex-col items-center">
        ...
        <div className="w-full flex justify-center">
          <ol className="mt-2 text-gray-300 list-decimal text-left">
      ...
      <div className="mb-6">
        ...
        <p className="mt-2 text-gray-400">
          ...
          and optionally conduct polls or votes within the platform. The system
          is designed to operate without a central authority, ensuring privacy
          and free speech.
        </p>
      </div>
